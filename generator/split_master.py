...
if __name__ == "__main__":
  try:
    images_dir = "./Tiled-Earth-Surface-Water-master/images/"
    masks_dir  = "./Tiled-Earth-Surface-Water-master/masks/"
    output_dir = "./Tiled-Earth-Surface-Water-ImageMask-Dataset/"
