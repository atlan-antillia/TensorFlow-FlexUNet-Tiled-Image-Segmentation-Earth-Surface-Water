  ...
  def generate(self, input_images_dir, input_masks_dir, 
    ...
    for image_file in image_files:
      ...
      if not os.path.exists(mask_file):
        raise Exception("Not found mask file " + mask_file)
...
if __name__ == "__main__":
  try:
    input_images_dir = "./Earth-Surface-Water/images/"
    input_masks_dir  = "./Earth-Surface-Water/masks/"

    output_dir        = "./Tiled-Earth-Surface-Water-master/"
    output_images_dir = "./Tiled-Earth-Surface-Water-master/images/"
    output_masks_dir  = "./Tiled-Earth-Surface-Water-master/masks/"
